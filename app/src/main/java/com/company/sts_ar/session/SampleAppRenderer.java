...
import com.company.sts_ar.loader.VideoBackgroundShader;
...
public class SampleAppRenderer {
    ...
    double getSceneScaleFactor()
    {
        ...
        // The height of the projected cover 'h' on this plane can then be calculated:
        //   tan(fov/2) = h/2d
        // which rearranges to:
        //   2d = h/tan(fov/2)
    ...
    // Configures the video mode and sets offsets for the camera's cover
