...
public abstract class Object3DImpl implements Object3D {
    ...
    public void draw(Object3DData obj, float[] pMatrix, float[] vMatrix, int textureId) {
        this.draw(obj, pMatrix, vMatrix, obj.getDrawMode(), obj.getDrawSize(), textureId);
    }
    ...
    public float[] getMMatrix(Object3DData obj) {
        ...
        if (obj.getScale() != null) {
            Matrix.scaleM(mMatrix, 0, obj.getScaleX() * scale, obj.getScaleY() * scale, obj.getScaleZ() * scale);
        }
