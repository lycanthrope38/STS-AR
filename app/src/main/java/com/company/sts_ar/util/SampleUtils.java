...
public class SampleUtils {
    ...
    // Transforms a screen pixel to a pixel onto the camera cover,
    // taking into account e.g. cropping of camera cover to fit different aspect
    // ratio screen.
    ...
    public static void screenCoordToCameraCoord(int screenX, int screenY,
        ...
        // Compute the angle by which the camera cover should be rotated clockwise so that it is
